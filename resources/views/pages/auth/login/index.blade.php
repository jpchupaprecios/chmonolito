...
@section('content')
    <div class="w-full max-w-md">
        <h1 class="text-3xl font-bold mb-6 text-center">Ingresar</h1>

        {{-- Error global si hay credenciales inválidas u otros fallos --}}
        ...
        <div class="mt-4 text-center">
            <a href="/recuperar-contrasena" class="text-sm text-blue-600 hover:underline">
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">¿No tienes una cuenta? <a href="/register" class="text-blue-600 hover:underline">Regístrate</a></p>
        </div>
